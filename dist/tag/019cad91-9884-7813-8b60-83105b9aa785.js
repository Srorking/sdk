(function () {
  ...
  q.push(["__meta", {
    project_id: "019cad91-9884-7813-8b60-83105b9aa785",
    cdnBase: base,
    tagVersion: "0.2.2"
  }]);
  ...
  function loadSdk() {
    ...
    s.async = true;
    s.src = base + "/core/sdk.min.js?pid=" + encodeURIComponent("019cad91-9884-7813-8b60-83105b9aa785") + "&v=" + encodeURIComponent("0.2.2");
