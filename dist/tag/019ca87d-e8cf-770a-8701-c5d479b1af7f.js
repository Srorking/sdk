(function () {
  ...
  q.push(["__meta", {
    project_id: "019ca87d-e8cf-770a-8701-c5d479b1af7f",
    cdnBase: base,
    tagVersion: "0.2.2"
  }]);
  ...
  function loadSdk() {
    ...
    s.async = true;
    s.src = base + "/core/sdk.min.js?pid=" + encodeURIComponent("019ca87d-e8cf-770a-8701-c5d479b1af7f") + "&v=" + encodeURIComponent("0.2.2");
  ...
  try {
    ...
    try {
      ...
      bootUrl = u.origin + u.pathname + "bootstrap?pid=" + encodeURIComponent("019ca87d-e8cf-770a-8701-c5d479b1af7f");
    } catch (e) {
